...
def create_model():
    with tf.distribute.MirroredStrategy(devices=["/gpu:0", "/gpu:1"], 
        ...
        pool_1 = layers.MaxPooling2D(pool_size=(3, 3), padding='valid')(conv_1)
        conv_2 = layers.Conv2D(16, (3,3), activation='relu', padding='same')(conv_1)
        pool_2 = layers.MaxPooling2D(pool_size=(3, 3), padding='valid')(conv_2)
        conv_3 = layers.Conv2D(32, (3,3), activation='relu', padding='same')(conv_2)
        pool_3 = layers.MaxPooling2D(pool_size=(3, 3), padding='valid')(conv_3)
